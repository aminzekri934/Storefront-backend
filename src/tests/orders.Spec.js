...
describe("Order Model", function () {
    ...
    it("INDEX method should return a list of all orders", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, id, productId, status, quantity, userId;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, store.index()];
                case 1:
                    _a = (_b.sent())[0], id = _a.id, productId = _a.productId, status = _a.status, quantity = _a.quantity, userId = _a.userId;
                    expect({ id: id, productId: productId, status: status, quantity: quantity, userId: userId }).toEqual({
    ...
    it("SHOW method should return the orders of a user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), id = _a.id, productId = _a.productId, status = _a.status, quantity = _a.quantity, userId = _a.userId;
                    expect({ id: id, productId: productId, status: status, quantity: quantity, userId: userId }).toEqual({
                        id: 1, productId: 1, status: "completed", quantity: 1, userId: 3
                    });
                    return [2 /*return*/];
